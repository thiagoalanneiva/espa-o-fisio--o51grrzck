    ...
    >
      ...
      <div className="container relative z-10 grid lg:grid-cols-2 gap-12 items-center py-16">
        <div className="space-y-8 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold-500/10 border border-gold-500/20 text-gold-400 text-sm font-medium">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-8 border-t border-white/10">
            <div className="space-y-1">
              ...
              <p className="text-sm text-white/60">Pacientes Atendidos</p>
            </div>
            <div className="space-y-1">
              <h4 className="text-2xl font-bold text-white flex items-center gap-2">
                <Users className="w-5 h-5 text-gold-500" /> Equipe
              </h4>
              <p className="text-sm text-white/60">Especializada</p>
            </div>
            <div className="space-y-1 hidden sm:block">
              <h4 className="text-2xl font-bold text-white flex items-center gap-2">
                <MapPin className="w-5 h-5 text-gold-500" /> 2
              </h4>
              <p className="text-sm text-white/60">Unidades na Região</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-float">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">No Google Reviews</p>
            </div>
          </div>
        </div>
      </div>
