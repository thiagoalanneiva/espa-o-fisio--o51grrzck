...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-white text-navy-900 font-bold py-2 px-4 rounded-xl shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none hidden md:block">
